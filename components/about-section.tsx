          ...
          <Card className="border-2 border-blue-100 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <CardContent className="p-8">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                ...
                <p>
                  SATPREM SOLUTIONS was founded with a clear purpose — to make pure, safe,
                  and reliable drinking water accessible to everyone, while helping
                  businesses strengthen their brand identity through custom white-label
                  solutions.
                </p>
                <p>
                  The idea for the company came from recognizing a growing need in the
                  market. We saw businesses and individuals seeking not just quality
                  water, but a trusted partner who could deliver consistency, purity,
            ...
            <CardContent className="p-8">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  ...
                  under its premium water brand{' '}
                  <span className="font-semibold text-blue-600">VAARI</span>, is dedicated
                  to delivering pure, refreshing, and safe drinking water to consumers
                  and businesses alike.
                </p>
                <p>
                  We specialize in bottled water distribution under our own trusted
                  brand, ensuring every drop reflects the highest standards of purity
                  and quality.
                </p>
              </div>
            </CardContent>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-2xl p-8 mb-6">
              ...
              <p className="text-gray-700 leading-relaxed text-center mb-6">
                Our water is sourced from a state-of-the-art Copper-Based RO Purifier,
                combining advanced Reverse Osmosis (RO) filtration technology with the
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-blue-50 rounded-xl p-6">
                ...
                <p className="text-gray-700">
                  Crystal-clear water free from contaminants, impurities, and harmful
                  substances through our multi-stage RO process.
                </p>
              </div>
              <div className="bg-cyan-50 rounded-xl p-6">
                ...
                <p className="text-gray-700">
                  Water enriched with copper&apos;s natural health-boosting properties,
                  including antimicrobial benefits and improved immunity.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-br from-blue-600 to-cyan-600 rounded-3xl shadow-2xl p-8 md:p-12 text-white">
          ...
          <div className="max-w-2xl mx-auto text-center">
            <p className="text-xl mb-6">
              VAARI water is certified by the Food Safety and Standards Authority of
              India (FSSAI), ensuring compliance with the highest food safety and quality
              standards.
            </p>
        ...
        <div className="mt-16 bg-white rounded-3xl shadow-xl p-8 md:p-12">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-lg text-gray-700 leading-relaxed text-center mb-8">
              Beyond our own brand, we offer premium white labeling services — providing
              customized bottled water solutions for hotels, restaurants, cafes,
              corporate offices, and event organizers.
            </p>
          </div>
        </div>
      </div>
